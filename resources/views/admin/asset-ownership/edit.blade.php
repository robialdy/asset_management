...
<div class="page-title">
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Edit Asset-Ownership</h3>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('asset-ownership.create') }}">Asset-Ownership</a></li>
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="text-end col">
                    <button type="button" class="btn btn-outline-primary" id="add-button">Edit-Ownership</button>
                </div>
            </div>
        </div>

        <div class="card-body">
            <form action="{{ route('asset-ownership.update', $asset->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
