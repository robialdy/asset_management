    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('submission-request.reply', $recommendation->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label for="reply_admin">Reply<span class="text-danger">*</span></label>
                                <textarea class="form-control" name="reply_admin" id="reply_admin" rows="4" placeholder="Enter Reply">{{ old('reply_admin') }}</textarea>
                                @error('reply_admin')
